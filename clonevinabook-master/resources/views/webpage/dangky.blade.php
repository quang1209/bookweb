...
<body>
            ...
            <div class="grid wide">
                <div class="header-with-search">
                    ...
                    <div class="log-and-reg">
                        <a class="log log-seperate js-log bold" style="text-decoration: none;color: black;"
                            href="{{ route('login') }}">
                            Đăng Nhập
                        </a>
                        <div class="reg bold">
                        ...
                        <div class="reg-top">
                            <div class="address-group">
                                <a href="" class="address">Trang chủ </a><i
                                    class="fa-solid fa-chevron-right reg-icon"></i><span class="address"> Tạo tài khoản
                                    mới</span>
                            </div>

                            <span class="reg-title">Chưa có tài khoản? Đăng ký ngay</span>
                        </div>
                        <div class="reg-bottom">
                            <div class="reg-bottom-left ">
                                <span class="reg-title reg-title-form">ĐĂNG KÝ TÀI KHOẢN</span>
                                <div class="reg-form">
                                    <form method="post" action="{{route('dangky')}}">
                                        @csrf
                                        <div class="reg-form-input-group">
                                            <span class="reg-form-text">Họ và Tên<span class="red "> *</span></span>
                                            <input type="text" name="fullname" value="{{ old('fullname') }}"
                                                class="reg-form-input" placeholder="Họ và Tên">
    ...
    right: -5px;">
                                        ...
                                        <div class="reg-form-input-group">
                                            <span class="reg-form-text">Xác nhận mật khẩu<span class="red ">
                                                    *</span></span>
                                            <input type="password" name="password_confirmation" class="reg-form-input">
    ...
    right: -5px;">
                                        ...
                                        <div class="reg-form-input-group">
                                            <span class="reg-form-text">Ngày sinh<span class="red "> *</span></span>
    ...
    right: -5px;">
                                        ...
                                        <div class="reg-form-input-group">
                                            <span class="reg-form-text">Giới tính</span>
                                            <input type="radio" id="Nam" name="gioitinh" value="nam"> <span
                                                class="radio">nam</span>
                                            <input type="radio" id="Nu" name="gioitinh" value="nu"><span
                                                class="radio">nữ</span>
    ...
    right: -5px;">
                                        ...
                                        <span class="reg-form-note">
                                            Vui lòng nhập các chữ số ở hình bên cạnh.
                                        </span>


                                </div>
                                <input type="submit" class="reg-button" value="Đăng Ký">
                                </form>
                            </div>
