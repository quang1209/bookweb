        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" method="POST" action="{{route('theloai.update',['theloai' => $theloai])}}">
                @csrf
                @method('put')
                <div class="box-body">
                    <div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input">
                      <input type="text" name="theloai" class="form-control" placeholder="Nhập thể loại" required value="{{$theloai->theloai}}">
                    </div>
                  </div>
                </div><!-- /.box-body -->
