        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-info">
              ...
              <!-- form start -->
              <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{route('sach.store')}}">
                @csrf
                @method('post')
                <div class="box-body">
                    <div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input">
                      <input type="text" name="ten" class="form-control" placeholder="Nhập tên sách" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input">
                      <input type="text" name="nhaphathanh" class="form-control" placeholder="Nhập tên tác giả" required>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input">
                      <input type="text" name="giakhuyenmai" class="form-control" placeholder="Nhập giá khuyến mãi" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Mô tả</label>
                    <div class="input">
                        <textarea id="editor1" name="mota" rows="10" cols="80"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Giấy phép</label>
                    <div class="input">
                      <input type="text" name="giayphep" class="form-control" placeholder="Nhập giấy phép" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Ngôn ngữ</label>
                    <div class="input">
                      <input type="text" name="ngonngu" class="form-control" placeholder="Nhập ngôn ngữ" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Kích thước</label>
                    <div class="input">
                      <input type="text" name="kichthuoc" class="form-control" placeholder="Nhập kích thước" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Số trang</label>
                    <div class="input">
                      <input type="text" name="sotrang" class="form-control" placeholder="Nhập số trang" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Khối lượng</label>
                    <div class="input">
                      <input type="text" name="khoiluong" class="form-control" placeholder="Nhập khối lượng" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Định dạng</label>
                    <div class="input">
                      <input type="text" name="dinhdang" class="form-control" placeholder="Nhập định dạng" required>
                    </div>
                  </div>
                </div><!-- /.box-body -->
