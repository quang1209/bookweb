        ...
        <div class="body">
            <div class="app-contain white">
                           ...
                           <div class="order-tilte">
                            ...
                            <div class="order-address-form">
                                <div class="order-address-form-group">
                                    ...
                                    <input type="text" name="hovaten" placeholder="Họ và tên" class="order-address-form-input">
                                </div>
                                <div class="order-address-form-group">
                                    <div class="order-address-form-text">
                                        Điện thoại
                                    </div>
                                    <input type="text" name="sodiethoai" placeholder="Điện thoại" class="order-address-form-input">
                                </div>
                                <div class="order-address-form-group">
                                    <div class="order-address-form-text">
                                        Địa chỉ
                                    </div>
                                    <input type="text" name="diachi" placeholder="Địa chỉ" class="order-address-form-input">
                                </div>
                            </div>
                            <div class="order-tilte">
                                Ghi chú giao hành
                ...
                <div class="bt-payment">
                    <button type="submit" class="bt-thanh-toan">Tiếp tục</button>
                    <a href="{{route('giohang')}}" class="bt-quay-lai">Quay lại</a>
                </div>
                    </form>
            </div>
        </div>
